...
#plt.xlim(-50,450)
#plt.ylim(4,0)
plt.plot(time, tidal1,'r-', lw=1.0, label='MFS1: Tidal')
...
#plt.ylim(0,18)
#plt.gca().invert_yaxis()
plt.plot(time, tidal2,'b-', lw=1.0, label='MFS2: Tidal')
...
#plt.xlim(-50,450)
#plt.ylim(0,18)
plt.plot(time, tidal1/tidal1.max(),'r-', label='MFS1: Tidal')
plt.plot(time, tidal2/tidal2.max(),'b-', label='MFS2: Tidal')
plt.xlabel('Days')
plt.ylabel('Amplitude (m)')
plt.legend(loc='lower right')
plt.xlabel('Days')
